...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtUserName" runat="server" OnTextChanged="TextBox1_TextChanged" style="z-index: 1; position: absolute; left: 212px; bottom: 495px; height: 24px; width: 166px"></asp:TextBox>
        ...
        <p>
            <asp:TextBox ID="txtPassword" runat="server" style="z-index: 1; left: 212px; top: 189px; position: absolute; height: 24px; width: 166px" TextMode="Password"></asp:TextBox>
        </p>
    </form>
</body>
</html>
