...
<body>
    <form id="form1" runat="server">
        <div style="height: 346px">
            ...
            <asp:Button ID="btnYes" runat="server" OnClick="btnYes_Click" style="z-index: 1; left: 209px; top: 185px; position: absolute; width: 62px" Text="Yes" />
            <asp:Button ID="btnNo" runat="server" height="26px" style="z-index: 1; left: 303px; top: 185px; position: absolute; width: 50px" Text="No" />
        </div>
    </form>
</body>
</html>
