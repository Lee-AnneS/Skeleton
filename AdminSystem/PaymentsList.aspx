...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnReturn" runat="server" OnClick="btnReturn_Click" style="z-index: 1; left: 378px; top: 505px; position: absolute" Text="Return to Main Menu" />
        ...
        <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" style="z-index: 1; left: 139px; top: 424px; position: absolute" Text="Delete" BorderColor="#CC3300" BorderStyle="Groove" />
