...
<body style="width: 359px; height: 400px;">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblCreatedAt" runat="server" style="z-index: 1; left: 10px; top: 220px; position: absolute" Text="CreatedAt" height="23px" width="88px"></asp:Label>
        ...
        <asp:TextBox ID="txtCreatedAt" runat="server" style="z-index: 1; left: 115px; top: 220px; position: absolute" width="122px"></asp:TextBox>
