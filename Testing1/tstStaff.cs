...
namespace Testing1
{
    ...
    public class tstStaff
    {
        ...
        public void StaffFullNameMaxLessOne()
        {
            ...
            StaffFullName = StaffFullName.PadRight(49, 'a');//this should be ok
            //invoke the method
            Error = AStaff.Valid(StaffFullName, StaffDoB, StaffEmail, NINumber, Salary);
            //test to see that the result is correct
            Assert.AreEqual(Error, "");
        ...
        public void StaffFullNameMax()
        {
            ...
            //create some test data to pass to the method
            string StaffFullName = "";
            StaffFullName = StaffFullName.PadRight(50, 'a');//this should be ok
            //invoke the method
            Error = AStaff.Valid(StaffFullName, StaffDoB, StaffEmail, NINumber, Salary);
            //test to see that the result is correct
            Assert.AreEqual(Error, "");
        ...
        public void StaffFullNameMaxPlusOne()
        {
            ...
            //create some test data to pass to the method
            string StaffFullName = "";
            StaffFullName = StaffFullName.PadRight(51, 'a');//this should fail
            //invoke the method
            Error = AStaff.Valid(StaffFullName, StaffDoB, StaffEmail, NINumber, Salary);
            //test to see that the result is correct
            Assert.AreNotEqual(Error, "");
        ...
        public void StaffFullNameMid()
        {
            ...
            //create some test data to pass to the method
            string StaffFullName = "";
            StaffFullName = StaffFullName.PadRight(25, 'a'); //this should be ok
            //invoke the method
            Error = AStaff.Valid(StaffFullName, StaffDoB, StaffEmail, NINumber, Salary);
            //test to see that the result is correct
            Assert.AreEqual(Error, "");
        ...
        public void NINumberMin()
        {
            ...
            String Error = "";
            //create some test data to pass to the method
            string NINumber = "a"; //this should not be ok
            //invoke the method
            Error = AStaff.Valid(StaffFullName, StaffDoB, StaffEmail, NINumber, Salary);
            //test to see that the result is correct
            Assert.AreNotEqual(Error, "");
